...
android {
    namespace = "com.kmm.kmmsharedcodecocoapods"
    compileSdk = 32
    defaultConfig {
        minSdk = 21
        targetSdk = 32
...
tasks.register("buildReleaseXCFramework", Exec::class.java) {
    ...
    val arm64FrameworkPath = "$rootDir/shared_cocoapods/build/bin/iosArm64/releaseFramework/${libName}.framework"
    val arm64DebugSymbolsPath =
        "$rootDir/shared_cocoapods/build/bin/iosArm64/releaseFramework/${libName}.framework.dSYM"

    val x64FrameworkPath = "$rootDir/shared_cocoapods/build/bin/iosX64/releaseFramework/${libName}.framework"
    val x64DebugSymbolsPath = "$rootDir/shared_cocoapods/build/bin/iosX64/releaseFramework/${libName}.framework.dSYM"
